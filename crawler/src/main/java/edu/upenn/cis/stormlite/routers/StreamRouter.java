...
public abstract class StreamRouter implements OutputFieldsDeclarer {
     ...
     * tuple. Will send both to remote and local nodes.
     *
     ...
     * Note that EOSes are always broadcast, independent of the grouping policy.
     *
     * @param context        Overall context
     * @param sourceExecutor (optional) ID of the sending executor
     */
     ...
     * message. Note that EOSes are always broadcast, independent of the grouping
     * policy.
     *
     * @param context        Overall context
     * @param sourceExecutor (optional) ID of the sending executor
